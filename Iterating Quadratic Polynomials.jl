...
# ╔═╡ 0acaa47a-7f92-11f0-3b47-3f34e2acba34
begin
	using PlutoUI
	using Plots
...
# ╔═╡ 5097f2d9-4b0f-45d0-b6e3-c7a48f17ff03
f(λ) = x -> λ*x*(1-x)

# ╔═╡ 3ebe79f4-a66e-47b8-87be-0d44d1652033
g(λ,n) = reduce(∘, Iterators.repeated(f(λ),n))

# ╔═╡ d91aaa6b-446b-4c9b-8b93-2fa2bc5d92b1
@bind n_iterates Slider(1:20,default=1, show_value=true)

# ╔═╡ a50a3f4c-2acf-4967-adc3-4dd535c9f277
@bind λ Slider(0:0.001:4,show_value=true, default=2)

# ╔═╡ df6e5c2c-ebd2-4f24-bb0c-8c0dcdd61540
md"n = $(n_iterates), λ = $(λ)"

# ╔═╡ c16e6e13-820a-4005-8ec1-692eaf2e9579
plot(g(λ,n_iterates), 0:0.001:1, yrange=(0,1),legend=false)

# ╔═╡ d3613e12-594e-4953-8045-a532ca995780
md"""
We now switch to a different approach, using the full-featured `DynamicalSystems` package. The base function is defined slightly differently for the interface. For instance, to treat systems uniformly, the functions take the time parameter `n` as an input, even though we will ignore it. 
"""

# ╔═╡ e954a87f-e336-4d3c-9118-cedf08f51558
md"""
**Note:** The following code should work, but runs into a bug with current versions of the relevant packages. 
"""

# ╔═╡ cbc796d3-4ec2-417e-b068-43ff1ff2cc45
logistic_rule(x,λ,n) = λ .* x .* (1 .- x)

# ╔═╡ 4ad10f69-58a3-44cd-9acc-2c6d4de5a825
# ╠═╡ disabled = true
#=╠═╡
logistic = DiscreteDynamicalSystem(logistic_rule, 0.5, 2.0)
  ╠═╡ =#

# ╔═╡ 1a1853bc-d1f0-4afc-8722-1f066b1dad80
# ╠═╡ disabled = true
#=╠═╡
interactive_cobweb(logistic,2:0.001:4,5)
  ╠═╡ =#
...
manifest_format = "2.0"
project_hash = "efaa23c401c16b053c56fae29eed1ba124c0fca0"
...
git-tree-sha1 = "dac2c4ea80fc2b77157a9d1573f77d3e4e028c58"
...
git-tree-sha1 = "00a6d5854ea022faf702a8802f6f34ff2f3593a2"
